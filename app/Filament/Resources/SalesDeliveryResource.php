...
use App\Filament\Resources\SalesDeliveryResource\RelationManagers;
...
{
    protected static ?string $model = SalesDeliveries::class;

    protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';

    protected static ?string $navigationLabel = 'Pengiriman Penjualan';
