            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="flex justify-between items-center mb-6">
                        <h3 class="text-lg font-medium">Detail Penjual:
                        </h3>
                    ...
                    <div class="border-t border-gray-200 dark:border-gray-700 pt-4">
                        <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-8">
                            <div class="sm:col-span-1">
                                <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Nama Penjual</dt>
                    ...
                    <div class="mt-8 flex justify-end">
                        ...
                        @if ($supplier->quantity_delivered_kg == 0)
