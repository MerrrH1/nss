        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <h3 class="text-lg font-medium mb-6">Tambah Unit Pengiriman untuk Kontrak: {{ $salesContract->contract_number }}</h3>
                    ...
                    <form method="POST" action="{{ route('sales_deliveries.store', $salesContract) }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2 p-4 bg-gray-100 dark:bg-gray-700 rounded-md">
                                ...
                                <p class="text-sm text-gray-900 dark:text-gray-200">
                                    Total Kuantitas: <span class="font-bold">{{ number_format($salesContract->total_quantity_kg, 0, ',', '.') }} Kg</span>
                                </p>
                                <p class="text-sm text-gray-900 dark:text-gray-200">
                                    Kuantitas Terkirim Saat Ini: <span class="font-bold">{{ number_format($salesContract->quantity_delivered_kg, 0, ',', '.') }} Kg</span>
                                </p>
                                <p class="text-sm text-gray-900 dark:text-gray-200">
                                    Sisa Kuantitas Tersedia: <span class="font-bold text-blue-600" id="remaining_contract_quantity">{{ number_format($salesContract->total_quantity_kg - $salesContract->quantity_delivered_kg, 0, ',', '.') }} Kg</span>
                                </p>
                            ...
                            <div>
                                ...
                                <input type="text" id="net_weight_kg_display"
                                    ...
                                    value="{{ old('net_weight_kg') }}" readonly>
                                <input type="hidden" name="net_weight_kg" id="net_weight_kg" value="{{ old('net_weight_kg') }}">
                                @error('net_weight_kg')
                                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                            </div>
